...
- [ ] **Lint**: Run `golangci-lint` on PRs and pushes
- [ ] **Test**: Run `go test ./...` with race detection
- [ ] **Build**: Verify the project builds on Linux and macOS
- [ ] **Code coverage**: Generate and upload coverage reports (Codecov or Coveralls)
- [ ] **Security scanning**: Run `govulncheck` for vulnerability detection
