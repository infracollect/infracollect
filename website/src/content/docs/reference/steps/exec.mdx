...
The exec step inherits the parent process environment. Additional variables can be added or overridden using the `env` field. Environment values support template expansion.
